    ...
    <div>
			...
			<div class="tab-content">
			  ...
			  <div role="tabpanel" class="tab-pane fade" id="company">
					<form class="form-horizontal" action="/admin/configuration/company" method="post">
					<fieldset>
					...
					<div class="form-group">
					  ...
					  <div class="col-md-4">
					  <input id="timetable" name="timetable" type="text" placeholder="Sexta: 8:00 AM - 18:00 PM" class="form-control input-md">
			  ...
			  <div role="tabpanel" class="tab-pane fade" id="social">
					<form class="form-horizontal" action="/admin/configuration/social" method="post">
						<fieldset>
							<!-- Text input-->
							<div class="form-group">
							  <label class="col-md-4 control-label" for="facebook"><i class="fa fa-facebook-square fa-2x text-info"></i></label>
							  <div class="col-md-4">
							  <input id="facebook" name="facebook" type="text" placeholder="https://facebook.com/" class="form-control input-md" value="<?= $social->facebook ?>">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-4">
							  <input id="linkedin" name="linkedin" type="text" placeholder="https://www.linkedin.com/in/..." class="form-control input-md" value="<?= $social->linkedin ?>">
							  <span class="help-block">Copie e cole o endereço do seu perfil/empresa da sua rede social.</span>
							  </div>
							</div>
							<!-- Text input-->
							<div class="form-group">
							  ...
							  <div class="col-md-4">
							  <input id="twitter" name="twitter" type="text" placeholder="https://twitter.com/..." class="form-control input-md" value="<?= $social->twitter ?>">
							  <span class="help-block">Copie e cole o endereço do seu perfil/empresa da sua rede social.</span>
							  </div>
							</div>
							<!-- Text input-->
							<div class="form-group">
							  ...
							  <div class="col-md-4">
							  <input id="gplus" name="gplus" type="text" placeholder="https://plus.google.com/..." class="form-control input-md" value="<?= $social->gplus ?>">
							  <span class="help-block">Copie e cole o endereço do seu perfil/empresa da sua rede social.</span>
							  </div>
							</div>
							<!-- Button -->
			  ...
			  <div role="tabpanel" class="tab-pane fade" id="password">
					<form class="form-horizontal" action="/admin/configuration/password" method="post">
						<fieldset>
							<!-- Password input-->
							<div class="form-group">
							  <label class="col-md-4 control-label" for="password">Senha Atual</label>
							  <div class="col-md-4">
							    <input id="old-pass" name="old-pass" type="password" placeholder="" class="form-control input-md" required="">
							  </div>
							</div>
							<!-- Password input-->
							<div class="form-group">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-4">
							    <input id="conf-pass" name="conf-pass" type="password" placeholder="" class="form-control input-md" required="">
							  </div>
							</div>
							<!-- Button -->
							<div class="form-group">
								<div class="col-md-4">
									<button id="cadPerson" name="cadSenha" class="btn btn-success pull-right">Salvar</button>
								</div>
							</div>
						</fieldset>
					</form>
